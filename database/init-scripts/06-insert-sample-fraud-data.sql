-- 06-insert-sample-fraud-data.sql (Versión corregida)
...
-- Especificar números de transacción únicos para evitar conflictos
...
('TXN-FRAUD-001', 1001, NULL, 850.50, 'COM001', 'Alimentación', 'Av. Corrientes 1500, CABA', 'Buenos Aires', 'Argentina', 'Débito', '14:30:00', '2024-09-15', FALSE, 'pos', 15000.00, 2.5),
('TXN-FRAUD-002', 1001, NULL, 3200.00, 'COM002', 'Combustibles', 'Panamericana Km 25', 'Buenos Aires', 'Argentina', 'Crédito', '08:15:00', '2024-09-16', FALSE, 'pos', 14149.50, 15.0),
('TXN-FRAUD-003', 1001, NULL, 4500.00, 'COM003', 'Gastronomía', 'Palermo, CABA', 'Buenos Aires', 'Argentina', 'Débito', '20:45:00', '2024-09-17', FALSE, 'pos', 10949.50, 5.0),
('TXN-FRAUD-004', 1001, NULL, 280.00, 'COM004', 'Salud', 'Florida 800, CABA', 'Buenos Aires', 'Argentina', 'Débito', '11:20:00', '2024-09-18', FALSE, 'pos', 6449.50, 1.0),
('TXN-FRAUD-005', 1002, NULL, 1200.00, 'COM001', 'Alimentación', 'Av. Corrientes 1500, CABA', 'Buenos Aires', 'Argentina', 'Crédito', '16:00:00', '2024-09-15', FALSE, 'pos', 25000.00, 3.0),
('TXN-FRAUD-006', 1002, NULL, 15000.00, 'COM009', 'Tecnología', 'Unicenter Shopping', 'Buenos Aires', 'Argentina', 'Crédito', '19:30:00', '2024-09-16', FALSE, 'pos', 23800.00, 10.0),
('TXN-FRAUD-007', 1002, NULL, 500.00, 'COM007', 'Bancario', 'Microcentro, CABA', 'Buenos Aires', 'Argentina', 'Débito', '12:00:00', '2024-09-17', FALSE, 'atm', 8800.00, 2.0),
('TXN-FRAUD-008', 1003, NULL, 650.00, 'COM002', 'Combustibles', 'Panamericana Km 25', 'Buenos Aires', 'Argentina', 'Débito', '07:45:00', '2024-09-15', FALSE, 'pos', 18000.00, 12.0),
('TXN-FRAUD-009', 1003, NULL, 2200.00, 'COM003', 'Gastronomía', 'Palermo, CABA', 'Buenos Aires', 'Argentina', 'Crédito', '21:15:00', '2024-09-16', FALSE, 'pos', 17350.00, 8.0),
-- Transacciones FRAUDULENTAS (es_fraude = TRUE)
('TXN-FRAUD-010', 1001, NULL, 45000.00, 'COM005', 'E-commerce', 'Ubicación desconocida', 'Desconocida', 'Desconocido', 'Crédito', '02:30:00', '2024-09-19', TRUE, 'online', 6169.50, 500.0),
('TXN-FRAUD-011', 1002, NULL, 85000.00, 'COM006', 'Entretenimiento', 'Las Vegas Strip', 'Las Vegas', 'Estados Unidos', 'Crédito', '03:45:00', '2024-09-18', TRUE, 'online', 8300.00, 10000.0),
('TXN-FRAUD-012', 1003, NULL, 25000.00, 'COM010', 'Financiero', 'Online', 'Miami', 'Estados Unidos', 'Crédito', '01:15:00', '2024-09-17', TRUE, 'online', 15150.00, 8000.0),
('TXN-FRAUD-013', 1001, NULL, 15000.00, 'COM008', 'Telecomunicaciones', 'Villa 31, CABA', 'Buenos Aires', 'Argentina', 'Débito', '23:45:00', '2024-09-20', TRUE, 'pos', 1169.50, 25.0),
('TXN-FRAUD-014', 1002, NULL, 5000.00, 'COM005', 'E-commerce', 'Ubicación desconocida', 'Desconocida', 'Desconocido', 'Crédito', '14:00:00', '2024-09-19', TRUE, 'online', 3300.00, 500.0),
('TXN-FRAUD-015', 1002, NULL, 4500.00, 'COM005', 'E-commerce', 'Ubicación desconocida', 'Desconocida', 'Desconocido', 'Crédito', '14:05:00', '2024-09-19', TRUE, 'online', -1700.00, 500.0),
('TXN-FRAUD-016', 1002, NULL, 3000.00, 'COM005', 'E-commerce', 'Ubicación desconocida', 'Desconocida', 'Desconocido', 'Crédito', '14:07:00', '2024-09-19', TRUE, 'online', -6200.00, 500.0)
...
WHERE codigo_comerciante IN (SELECT DISTINCT comerciante FROM transacciones);
